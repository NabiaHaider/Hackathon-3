...
const ProductDetail = ({ product }: { product: Product }) => {
  const { addToCart } = useCart(); // Ensure this works correctly in CartContext
  ...
  const handleAddToCart = () => {
    ...
    addToCart({
      ...
      name: product.name,
      price: product.price,
      image: urlFor(product.image)?.url() || '', // Ensure URL exists
      quantity,
    });
      ...
      <div className="flex flex-col justify-between bg-white p-8 rounded-lg shadow-md space-y-6 animate-slideInRight">
        ...
        <div className="flex space-x-4">
          ...
          <button 
            ...
            className="bg-red-600 text-white px-6 py-3 rounded-lg shadow-md hover:bg-red-700 transition transform hover:scale-105"
          >
